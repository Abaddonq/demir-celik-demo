...
const atomIcon = (
  <svg width="32" height="32" fill="none" viewBox="0 0 24 24" className="text-white mr-4 flex-shrink-0">
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-12 pt-8 pb-12 flex flex-col gap-12">
        {/* Başlık */}
        <h1 className="text-3xl md:text-4xl font-bold text-left text-[#202b85] mb-2">Tarihçemiz</h1>
        {/* Üst açıklama */}
        <div className="text-base md:text-lg font-semibold text-[#202b85] leading-relaxed mb-8">
          Ülkemizin ve Üniversitemizin ilklerinden olan Karabük Üniversitesi Demir Çelik Enstitüsü'nün (KDÇE) kuruluşuna ait karar, 03/07/2011 tarih, 27983 sayı ve 2011/2018 karar sayı ile Resmi Gazete'de yayımlanmıştır. 2012 yılından itibaren aktif olarak hizmet vermeye başlamıştır. 2016 yılında TÜRKAK tarafından 17025 standardına göre 14 farklı deney metodundan akredite edilmiştir. Günümüzde MARGEM (Malzeme Geliştirme Uygulama ve Araştırma Merkezi) ve YEMMMER 'e (Yenilenebilir Enerji Mühendisliği Araştırma ve Uygulama Merkezi) de ev sahipliği yaparak koordineli çalışmaktadır.
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mt-12">
          <div className="relative w-full md:w-1/2 flex-shrink-0">
            ...
            <Image src="/images/Laboratuvarlar.png" alt="Misyonumuz" width={700} height={500} className="rounded-[60px_0_0_60px] object-cover relative z-0" />
          </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8 mt-12">
          <div className="relative w-full md:w-1/2 flex-shrink-0">
            ...
            <Image src="/images/lab.jpg" alt="Vizyonumuz" width={700} height={500} className="rounded-[0_60px_60px_0] object-cover relative z-10" />
          </div>
          <div className="w-full md:w-1/2 flex flex-col justify-center bg-[#202b85] rounded-[0_60px_60px_0] p-8 md:-mr-12 z-10 relative">
            ...
            <p className="text-white mb-4 font-medium">Demir Çelik Enstitüsü Türk demir çelik endüstrisinin uluslar arası rekabet edebilir olması için gelişmesini, alan çalışanları için iş sağlığı ve güvenliği konularında yüksek etik standartların oluşmasını amaçlar. Sürdürülebilir bir demir çelik endüstrisi için Demir Çelik Enstitüsü'nün özgörüsü:</p>
            <ul className="space-y-6">
              <li className="flex items-start text-white font-bold">{atomIcon} Demir çelik endüstrisi ve diğer anahtar sektörler için zorlukları paylaşacak bir platform oluşturmak, bilim ışığında çözümler geliştirmek,</li>
              <li className="flex items-start text-white font-bold">{atomIcon} Sürdürülebilir bir gelişme için yeni teknolojileri geliştirme amaçlı alandaki araştırmaları desteklemek,</li>
              <li className="flex items-start text-white font-bold">{atomIcon} Yeni teknolojilerin kullanılmasıyla CO₂ atıklarının azaltılması için farkındalık oluşturmak,</li>
              <li className="flex items-start text-white font-bold">{atomIcon} Çelikten yapılmış ürünlerin pazar payının artırılması yoluyla, en fazla geri dönüşümü olan bu malzemenin kullanılmasını desteklemek,</li>
              <li className="flex items-start text-white font-bold">{atomIcon} Stratejik endüstrilerin gelişmesine güç sağlamak için gerekli olan yüksek performanslı çelik malzemelerin üretilmesini geliştirmektir.</li>
            </ul>
          </div>
        </div>
      </div>
