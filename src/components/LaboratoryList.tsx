    ...
    >
      ...
      <div className="mt-4 md:mt-6 space-y-2 md:space-y-3 border-t pt-3 md:pt-4 text-xs md:text-sm" style={{ borderColor: underlineColor }}>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1 md:gap-2 mt-1 md:mt-2 text-xs md:text-sm hover:underline"
        >
...
function MenuItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="truncate font-medium text-sm md:text-base" style={{ color: textColor }}>
          {title}
        </span>
...
function ContactItem({
  ...
  return (
    <div className="flex items-start gap-2 md:gap-3">
      <div className="mt-0.5 md:mt-1 text-sm md:text-lg" style={{ color: iconColor }}>
        {icon}
      </div>
      <div>
        <p className="text-xs md:text-sm font-semibold" style={{ color }}>
          {label}
        </p>
