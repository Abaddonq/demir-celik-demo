...
(0, dotenv_1.config)(); // Environment variables'ları yükle
...
console.log("Seed script başlatıldı...");
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, hashedPassword, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, index_1.db.insert(schema_1.admin).values({
                            email: email,
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("❌ Admin eklenemedi:", error_1);
                    return [3 /*break*/, 4];
